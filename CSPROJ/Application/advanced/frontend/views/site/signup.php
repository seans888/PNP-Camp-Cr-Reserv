   ...
   <!--  <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-md-offset-4">
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <b><p>Home Address</p></b>
                <?= $form->field($model, 'home_address')->textInput(['maxlength' => true, 'placeholder' => 'No., Street, Barangay/Subdivision/Munincipality/City/Province'])->hint('')->label(false) ?><br>
