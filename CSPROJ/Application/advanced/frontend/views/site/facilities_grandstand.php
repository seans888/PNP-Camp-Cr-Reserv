           ...
           <div class="row" >
                 ...
                 <h4>
                   ...
                   <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="about-div">
                     <img src="<?= Yii::$app->request->baseUrl ?>/images/grandstandicon.jpg" width="90" height="90"></i>
                   <h3 >Type</h3>
                 <hr />
                    <h4>
                        Outdoor
                 ...
                 <hr />
                   <h4>
                       <b>GRANDSTAND:</b> P 5,000.00 / PER HOUR<br>
                       P 10,000.00 / WHOLE DAY<br>
                       <b>   OVAL / PARADE:</b> P 10,000.00 / PER DAY <br>
                       P 20,000.00 / WHOLE DAY
