    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill">
                <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt.jpg') ?>" />
 </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill">
                  <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt1.jpg') ?>" />
            ...
            <div class="item">
                ...
                <div class="fill">
                  <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt2.jpg') ?>" />
            ...
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill">
                  <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt3.jpg') ?>" />
            ...
            <div class="item">
                <!-- Set the third background image using inline CSS below. -->
                <div class="fill">
                  <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt4.jpg') ?>" />
            ...
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill">
                  <img class ="slideshow" src="<?= yii\helpers\Url::to('@web/images/basketballcourt5.jpg') ?>" />
